...
describe('DynamicFormQuestionComponent', function () {
    ...
    beforeEach(testing_1.async(function () {
        testing_1.TestBed.configureTestingModule({
            declarations: [dynamic_form_question_component_1.DynamicFormQuestionComponent]
        })
            .compileComponents();
    }));
    beforeEach(function () {
        fixture = testing_1.TestBed.createComponent(dynamic_form_question_component_1.DynamicFormQuestionComponent);
