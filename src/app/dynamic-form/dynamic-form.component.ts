...
export class DynamicFormComponent implements OnInit {
    ...
    @Input() data: string;//The url or data from which the dynamic form data is gathered
    ...
    getQuestions(): void {
        ...
        this.obsQuestions = this.qcs.getQuestions(this.data);
        this.obsQuestions.subscribe(questions =>
            this.makeQuestions(questions["data"])
        );
    }
    ...
    onSubmit() {
        ...
        if (this.form.valid) {
            ...
            this.qcs.submitForm(this.form, this.action).subscribe(results => 
                function(){}
            );
